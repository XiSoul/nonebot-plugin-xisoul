...
class DateParser:
    ...
    @staticmethod
    def parse_strict_ymd_date(date_str: str) -> Optional[Tuple[int, int, int]]:
        """
        严格解析 YYYY-MM-DD 格式的日期字符串
    ...
    @staticmethod
    def parse_strict_ymd_from_command(command: str) -> Optional[Tuple[int, int, int]]:
        """
        为黄历命令严格解析日期。
        仅支持空参数/相对日期关键词/严格 YYYY-MM-DD。
        ...
        return DateParser.parse_strict_ymd_date(command)
